...
It's time to link the two PCBs. Grab the first PCB/Frontpanel and connect the 3 white wires (P21, P22, P23). These three wires control the rotary encoder's RGB LEDs - with the jumpers for P21, P22 & P23 in the default position that is. More about these jumpers later<br><br>
